(function() {
    ...
    function component(object) {
      ...
      function showSubscribeChannelModal() {
          if (isCodeObtained) return;
          ...
          var modalHtml = '<div>' +
                          '<script>' +
                              'document.getElementById("qrCodeImage").src = "http://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://t.me/showybot"' +
                          '</script>' +
                          '<img id="qrCodeImage"/>' +
                          '<p>Р”Р»СЏ РёСЃРїРѕР»СЊР·РѕРІР°РЅРёСЏ РїР»Р°РіРёРЅР° Showy РІС‹ РґРѕР»Р¶РЅС‹ Р±С‹С‚СЊ РїРѕРґРїРёСЃР°РЅС‹ РЅР° Telegram РєР°РЅР°Р»С‹, РїРѕРґСЂРѕР±РЅРµРµ РІ С‚РµР»РµРіСЂР°Рј-Р±РѕС‚Рµ @showybot РёР»Рё РїРѕ СЃСЃС‹Р»РєРµ t.me/showybot</p>' +
                          '</div>';
